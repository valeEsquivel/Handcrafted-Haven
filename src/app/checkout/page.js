            ...
            {steps.map((s, i) => {
              ...
              return (
                ...
                >
                  ...
                  {i < steps.length - 1 && (
                    <div
                      className={`flex-1 h-0.5 mx-2 mb-4 ${step > s.n ? "bg-green-600" : "bg-border"}`}
                    />
                  )}
                </div>
              );
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit}>
              {step === 1 && (
                <Card className="p-6">
                  <h2 className="text-2xl font-bold mb-6 text-foreground flex items-center gap-2">
                    <User className="w-6 h-6 text-primary" /> Contact
                    Information
                  </h2>
              ...
              {step === 2 && (
                <Card className="p-6">
                  <h2 className="text-2xl font-bold mb-6 text-foreground flex items-center gap-2">
                    <Package className="w-6 h-6 text-primary" /> Shipping
                    Address
                  </h2>
                  <div className="space-y-4">
                    <div>
